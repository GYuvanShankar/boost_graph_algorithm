...
typedef boost::property<boost::edge_weight_t, double> EdgeWeight;//for main
typedef boost::adjacency_list<boost::listS, boost::vecS, boost::directedS, boost::no_property, EdgeWeight> DirectedGraph;//for main
...
int main()
{
    ...
    std::cout<<boost::karp_minimum_mean_cycle(g);
}